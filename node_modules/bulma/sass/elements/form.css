...
body:before {
  ...
  content: "Error: Undefined variable: \"$grey-darker\".\A         on line 1 of C:\Users\Hans\Documents\GitHub\rendyr.github.io\node_modules\bulma\sass\elements\form.sass\A \A 1: $input-color: $grey-darker !default\A 2: $input-background-color: $white !default\A 3: $input-border-color: $grey-lighter !default\A 4: $input-height: $control-height !default\A 5: $input-shadow: inset 0 1px 2px rgba($black, 0.1) !default\A 6: "; }
