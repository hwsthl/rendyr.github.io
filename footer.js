            ...
            <div class="row">\
                <div class="col-lg-4 col-md-4">\
                    <div class="mb-5 mb-md-0 text-center text-md-left">\
                        <!-- logo -->\
                        <img class="mb-30" src="images/logo_footer.png" alt="logo">\
                        <p class="text-white mb-30">Rendyr Inc. is a desktop robotics company that works to make design easier and more accessible to everyone.</p>\
                        <!-- social icon -->\
                        <ul class="list-inline">\
                            <li class="list-inline-item">\
                                <a class="social-icon-outline" target="_blank" href="https://www.instagram.com/rendyr.inc">\
                                    <i class="ti-instagram"></i>\
                                </a>\
                            </li>\
                            <li class="list-inline-item">\
                                <a class="social-icon-outline" target="_blank" href="https://www.facebook.com/rendyrinc">\
...
-->\
                ...
                <ul class="footer-links">\
                    ...
                    <li>\
                        <a href="optic.html">Optic</a>\
                    </li>\
                    <li>\
                        <a href="kaelum.html">Kaelum</a>\
                    </li>\
                </ul>\
                </div>\
                <!-- footer links -->\
                <div class="col-lg-2 col-md-4 col-6">\
                <h4 class="transparent-text mb-4"> rendyr</h4>\
                <ul class="footer-links">\
                    <li>\
            ...
            <div class="row">\
                <div class="col-lg-6 col-md-5">\
                    <p class="text-white text-center text-md-left">\
                        \
                        <span class="text-primary">Rendyr Inc.</span> &copy; <script>document.write((new Date()).getFullYear());</script> All Right Reserved</p>\
                </div>\
<!--\
