...
<header>\
    ...
    <div class="navigation" background="ff5000">\
        <div class="container" background="ff5000">\
            <nav class="navbar navbar-expand-lg navbar-light bg-light" background="ff5000">\
                <a href="index.html">\
...
\
                        ...
                        <li class="nav-item">\
                            <a class="nav-link" href="optic.html">Optic</a>\
                        </li>                 \
<!--                        <li class="nav-item">-->\
...
<!--                        </li>-->\
                        ...
                        <li class="nav-item">\
                            <a class="nav-link btn btn-primary btn-sm" href="contact.html">get in touch</a>\
                        </li>\
                    </ul>\
                </div>\
            </nav>\
